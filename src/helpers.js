...
function seedDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var recipeRepository, ratingsRepository, userRepository, defaultUser, recipes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    recipeRepository = (0, typeorm_1.getRepository)(recipe_1.Recipe);
                    ratingsRepository = (0, typeorm_1.getRepository)(rate_1.Rate);
                ...
                case 1:
                    _a.sent();
                    recipes = recipeRepository.create([
                        {
                            title: "Recipe 1",
                            description: "Desc 1",
