...
var RateResolver = /** @class */ (function () {
    function RateResolver(userRepository) {
        this.userRepository = userRepository;
    }
    RateResolver.prototype.user = function (rate) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findOne({ where: { id: rate.userId }, cache: 1000 })];
